...
PERSPECTIVE_V   = 0          # recommanded : 0.5
PERSPECTIVE_H   = 0         # recommanded : -0.25 

POV_X           = 0           # recommanded : 1.0
POV_Y           = 0          # recommanded : -1.0
WARP_STRENGTH   = 0          # recommanded : 0.37
...
FOCUS_X      = 0.75     # 0.75 targets the right side (0.0 = Left, 1.0 = Right)
FOCUS_Y      = 0.5     # 0.25 targets the top side (0.0 = Top, 1.0 = Bottom)
